<template>
  <div class="bg-gray-800 w-screen h-full text-white">
    <div class="text-right">
      <div class="px-12 py-6 flex justify-end">
        <div class="transform rotate-90 text-xl">III</div>
      </div>
    </div>

    <div class="flex justify-center p-10">
      <div class="p-10 rounded-3xl bg-gray-900 shadow-2xl">
        <div class="w-20 h-20 rounded-full bg-gray-100 mx-auto mb-4"></div>
        <div class="font-bold text-center my-1">Edgar Sanchez</div>
        <div class="font-light text-center">Full Stack Developer</div>
        <hr class="my-2" />
    ...
    <div class="flex justify-center">
      <div>
        ...
        <div class="mx-20 text-center">
          Desarrollador de paginas Web, con experiencias en varios lenguajes de
          programacion.
        </div>
        <div class="mx-20 text-center">
          Web Developer, with experience in different programming languages
        </div>
        ...
        <div class="mx-20 text-center p-10">
          ...
          <div class="grid grid-cols-3 gap-4 text-center py-10">
            ...
            <ButtonVue v-for="button, key in buttons" :key="key"  :to='button.to' :title="button.title" />
    
          </div>
        </div>

        <div class="mx-20 flex justify-center text-center space-x-2 my-2">
          <python />
          <php />
          <node />
          <js />
...
<script>
import html5 from "./icons/html5.vue";
import ccs3 from "./icons/ccs3.vue";
